...
2. ~~Функция `delete_current_user()`~~ — выполнена в проекте 2026-09-04 и проверена на тестовом аккаунте.
3. ~~Регион Supabase~~ — eu-west-1 (Ирландия), указан в `web/privacy.html`.
